...
Calculate the evaporation ratios and actual consumption values for each plant [i] and month-DC [j] for the suite of tower characteristics. The heat load has to be converted from MBTU/month, the BTU/hr,
